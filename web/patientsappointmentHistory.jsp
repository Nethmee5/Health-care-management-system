<%-- 
    Document   : patientsappointmentHistory
    Created on : April 21, 2021, 6:59:52 PM
    Author     : vinu
--%>
...
<html lang="en">
    <head>
        ...
        <title>History | Healthcare Shield</title>
    ...
    <body>
        ...
        <h1 class="jumbotron" style="line-height: 1px;">History</h1>
        ${msg}
        ...
        <!--            <div class="card bg-light text-dark my-2 shadow">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="col">
                                <p class="card-text">Medical Assistant</p>
                                <p class="card-text">Name</p>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <p class="card-text bold font-weight-bolder text-info btn btn-light">LKR 5000.00</p>
                                <input type="submit" value="Book Same" class="btn btn-primary">
                            </div>
                        </div>
