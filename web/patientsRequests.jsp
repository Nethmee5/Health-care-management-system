<%-- 
    Document   : cpatientsRequests
    Created on : April 21, 2021, 9:44:43 AM
    Author     : vinu
--%>
...
<html lang="en">
    <head>
        ...
        <title>Pending Appointments | Health Shield</title>
    ...
    <body>
        ...
        <h1 class="jumbotron" style="line-height: 1px;">Pending Appointments</h1>
        ${msg}
