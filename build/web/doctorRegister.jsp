<%-- 
    ...
    Created on : April 25, 2021, 4:30:27 PM
    Author     : vinu
--%>
...
<html lang="en">
    <head>
        <title> Doctor Registration | Health Shield</title>
        <!--nav-->
    ...
    <body>
            ...
            <div class="container">
              <!--  <div class="row justify-content-between">
                    <div class="col d-flex align-items-center">
                        <p class="mb-0 phone">
                            <span class="mailus">Idea Seekes</span
                            ><span class="mailus"> email developers:</span>
                            <a href="#">Ideaseekers@gmail.com</a>
                        </p>
                    </div>
                </div>-->
            </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                      ...
                      <!--  <li class="nav-item">
                            <a href="services.html" class="nav-link">About</a>
                        </li>
                        <li class="nav-item">
                            <a href="rooms.html" class="nav-link">Contact</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                    ...
                    <form action="/app/admin" method="POST">
                        <div class="container" style="align-items:center; padding-left: 150px;">
                            ...
                            <input
                                ...
                                required
                                /><br />
                             <h6 style="color:black;">Hospital :</h6>
                            <input
                                type="text"
                                class="form-control"
                ...
                <div class="col-sm-6" style="background-color: white;">
                    <img src="Images/docrrr.jpg"   width="600px" height="600px"  />
                </div>
            </div>
        </div>
        <br /><br /><br /><br />
