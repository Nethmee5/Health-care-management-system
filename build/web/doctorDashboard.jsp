<%-- 
    ...
    Created on : April 22, 2021, 4:08:58 PM
    Author     : vinu
--%>
...
<html lang="en">
    <head>
        ...
        <title>Dashboard | Health Shield</title>
            ...
            <div class="row">
                ...
                <div class="col-6 my-2" style="background-color:white;">       
                    <div class="container btn btn-lg btn-dark">
                        <a href="/app/agent?q=profile&id=${id}">
                ...
                <div class="col-6 my-2" style="background-color:white;">       
                    <div class="container btn btn-lg btn-dark">
                        <a href="/app/agent?q=requests&id=${id}">
                            <div class="card-body row">
                                
                                <img class="card-img-top col-4 my-auto" src="Images/2.png" alt="Card image"> 
                                <h2 class="card-title col-6 diaplay-4 text-light">Pending Appointments</h2>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-6 my-2" style="background-color:white;">       
                    <div class="container btn btn-lg btn-dark">
                        <a href="/app/agent?q=bookings&id=${id}">
                            <div class="card-body row">
                               
                                <img class="card-img-top col-4 my-auto" src="Images/96.png" alt="Card image"> 
                                <h2 class="card-title col-6 diaplay-4 text-light">Bookings</h2>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-6 my-2" style="background-color:white;">       
                    <div class="container btn btn-lg btn-dark">
                        <a href="/app/auth?q=leave&role=agent">
                            <div class="card-body row">
