<%-- 
    ...
    Created on : April 22, 2021, 3:19:23 PM
    Author     : vinu
--%>
...
<html lang="en">
    <head>
        ...
        <title>Doctor Login | Health Shield</title>
        <!--nav-->
        ...
        <div class="container p-4 text-center">
            ...
            <center>
                ...
                <form action="/app/auth" method="post">
                    ...
                    <hr>
                    <div class="form-group">
                        <p class="f" style="color:lightslategray">Don't you have a account?Click Here  <a href="doctorRegister.jsp" target="doctorRegister.jsp" style="color:black">Register</a></p>
                    </div>
